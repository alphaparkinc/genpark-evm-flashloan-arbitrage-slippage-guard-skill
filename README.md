# genpark-evm-flashloan-arbitrage-slippage-guard-skill
...
**genpark-evm-flashloan-arbitrage-slippage-guard-skill** is a deterministic, zero-dependency Python skill engineered for autonomous smart contract auditing, callgraph verification, signature phishing defense, and DeFi vulnerability triage.

> **Executive Capability**: EVM flash loan arbitrage price impact & MEV sandwich protection guard (Aave / Uniswap v3)
...
result = client.evaluate_flashloan_slippage_risk()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-evm-flashloan-arbitrage-slippage-guard-skill": {
      "command": "python",
      "args": ["/path/to/genpark-evm-flashloan-arbitrage-slippage-guard-skill/mcp_server.py"]
    }
  }
}
```
